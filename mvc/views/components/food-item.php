...
echo "<a href='#' class='img-prod'><img class='img-fluid' accept='image/*' src='" . $base_url . $assets_url . "images/food/" . $item['foodImage'] . "' alt='Colorlib Template'>";
echo "<span class='status'>30%</span>";
echo "<div class='overlay'></div>";
echo "</a>";
echo "<div class='text py-3 pb-4 px-3 text-center'>";
echo "<h3><a href='#'>" . $item['foodName'] . "</a></h3>";
echo "<div class='d-flex'>";
echo "<div class='pricing'>";
echo "<p class='price'><span class='mr-2 price-dc'>" . $item['price'] . "vnd</span><span class='price-sale'>" . $item['price'] . "vnd</span></p>";
echo "</div>";
echo "</div>";
